    ...
    <>
      ...
      <ImageBackground source={require('../assets/bg.png')} style={styles.container} resizeMode="cover">
        <View style={styles.header}>
          <Image source={require('../assets/icon1.png')} style={{ width: 240, height: 100, marginBottom: 12 }} />
          <Text style={styles.title}>MyJourney</Text>
          <Text style={styles.subtitle}>Game Based Learning Geografi Jawa Barat</Text>
        </View>
